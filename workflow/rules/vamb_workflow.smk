rule cat_contigs:
    input:
       "results/current/bioawk/{sample}/assembly.fasta" 
    output:
...
# [TODO] deploy the functionality of Vamb to integrate many samples 
        "cp {input} {output}"
...
rule vamb:
    conda:
        "/home/haicu/anastasiia.grekova/workspace/puntseqWGS/.snakemake/conda/978870a6"
    input:
        catalog = "results/current/bioawk/{sample}/assembly.fasta", 
    ...
    output:
        ...
        directory("results/current/vamb/{sample}/bins/")	
