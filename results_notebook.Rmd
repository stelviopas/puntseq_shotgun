...
comparison_low_abun_dt <- comparison_dt[(phylum != 'unclassified'),] %>% .[,.(scaled_shotgun = rescale_abundance(shotgun),
                                                                         scaled_BC02 = rescale_abundance(BC02),
                                                                         scaled_BC03 = rescale_abundance(BC03),
                                                                         scaled_BC04 = rescale_abundance(BC04),
                                                                         phylum)]
low_abun_mat <- as.matrix(comparison_low_abun_dt[, c( "scaled_shotgun",
                                   "scaled_BC02",
                                   "scaled_BC03",
                                   "scaled_BC04")])
